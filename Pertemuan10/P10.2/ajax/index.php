...
<script type="text/javascript">
    ...
    $("#simpan").click(function() {
            ...
            var jenkeli = document.getElementById("jenkeli").value;
            ...
            if (jenkel1Checked == false && jenkel2Checked == false) {
            ...
            if (nama !== "" && alamat !== "" && (document.getElementById("jenkeli").checked === true || document.getElementById("jenkel2").checked === true) && no_telp !== "") {
                $.ajax({
                    type: 'POST',
                    url: "form_action.php",
                    data: data,
